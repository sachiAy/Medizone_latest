...
export default {
  ...
  data() {
    return {
      others: [
        { text: "Medical History", route: "/Doctor" },
        { text: "Terms & Conditions", route: "/Terms" },
        { text: "FAQ", route: "/Doctor" },
        { text: "Feedback", route: "/Doctor" },
        
      ],
      abouts:[
        {text: "The Company", route:"./AboutUs"},
        {text: "Investor Relations", route:"./AboutUs"},
        {text: "Partners", route:"./AboutUs"},
        {text: "Careers", route:"./AboutUs"}
